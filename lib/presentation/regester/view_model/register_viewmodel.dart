...
class RegisterViewModel extends BaseViewModel
  ...
  StreamController mobilenamberStreamController =
      StreamController<String>.broadcast();
  StreamController emailStreamController = StreamController<String>.broadcast();
  StreamController passwordStreamController =
      StreamController<String>.broadcast();
  StreamController pictureStreamController = StreamController<File>.broadcast();
  ...
  void dispose() {
    ...
    mobilenamberStreamController.close();
    emailStreamController.close();
    passwordStreamController.close();
    pictureStreamController.close();
  ...
  @override
  Sink get inputMobileNumber => mobilenamberStreamController.sink;

  @override
  Sink get inputPassword => passwordStreamController.sink;

  @override
  Sink get inputProfilePicture => pictureStreamController.sink;
...
// Mobile Numper
  ...
  Stream<bool> get outputIsMobileNumberValid =>
      mobilenamberStreamController.stream
...
// Picture
  ...
  Stream<File> get outputProfilePicture {
    return pictureStreamController.stream.map((file) => file);
  }
